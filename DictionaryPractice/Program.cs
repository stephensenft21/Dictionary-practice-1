...
*/
            ...
            */
            ...
            foreach (var wordData in dictionaryOfExcitedWords)
            {
            ...
            foreach (var wordData in dictionaryOfNewWords)
            {
            ...
            foreach (var wordData in dictionaryOfFunWords)
            {
            ...
            foreach (var wordData in dictionaryOfBadWords)
            {
